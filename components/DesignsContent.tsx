...
/**
 * Shared designs content used by both `/designs` (landing) and `/dashboard/designs` (sidebar).
 * Pass `showCta={false}` to hide the bottom CTA section inside the dashboard.
 */
export function DesignsContent({ showCta = true }: { showCta?: boolean }) {
  return (
    <>
      {/* Hero */}
      ...
      {/* Colors & shapes */}
      <section id="colors" className="w-full bg-black px-6 py-16 lg:py-24">
      ...
      {/* Print styles */}
      <section id="print" className="w-full border-t border-white/10 bg-black px-6 py-16 lg:py-24">
        <div className="mx-auto max-w-3xl">
          <div className="flex items-center gap-3">
            <div className="flex size-10 items-center justify-center rounded border border-white/10 bg-white/5">
