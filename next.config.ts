...
const buildCsp = () => {
  const directives = [
    "default-src 'self'",
    "connect-src 'self' https://clerk-telemetry.com https://*.clerk-telemetry.com https://api.stripe.com https://maps.googleapis.com https://img.clerk.com https://*.clerk.accounts.dev https://*.clerk.com https://ik.imagekit.io",
    ...
    "script-src 'self' 'unsafe-inline' https: http: https://*.js.stripe.com https://js.stripe.com https://maps.googleapis.com https://challenges.cloudflare.com",
